...
vlog -work work DCM_50M_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax DCM_50M_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.DCM_50M_tb work.glbl
